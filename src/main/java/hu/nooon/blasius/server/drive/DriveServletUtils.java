package hu.nooon.blasius.server.drive;
...
public abstract class DriveServletUtils extends HttpServlet {
    ...
    private static final String SERVICE_ACCOUNT = "145741083546@developer.gserviceaccount.com";
    private static final String CERT_PATH = "/WEB-INF/cert.p12";
